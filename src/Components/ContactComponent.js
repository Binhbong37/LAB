...
class Contact extends Component {
    ...
    handleInputChange = (e) => {
        ...
        let value = target.type === 'checkbox' ? target.type : target.value
        this.setState({
            [name]: value
        })
    }
                    ...
                    <div className="col-12 col-md-9">
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="text" id="tel" className="form-control" name="telnum"
                                    placeholder="Tel. Num" value={this.state.telnum} onChange={this.handleInputChange}/>
                                </Col>
                            </FormGroup>
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    ...
                                    placeholder="Your Email" value={this.state.email} onChange={this.handleInputChange}/>
                                </Col>
                            </FormGroup>
                            <FormGroup row>
